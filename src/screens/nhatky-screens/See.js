    ...
    return (
        <View style={styles.container}>
            <View style={{ justifyContent: 'space-between', flex: 1 }}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'space-between', height: 40, flexDirection: 'row' }}>
                    <TouchableOpacity onPress={() => navigation.goBack()} >
                        <Text style={{ color: "#ffff", marginLeft: 10 }}>
                            Đóng
                        </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity>
                        <Text style={{ fontSize: 40, marginBottom: 23, marginRight: 10, fontWeight: 500, color: "#ffff" }}>...</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ height: 150 }}>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 9 }}>
                        <View style={{ width: "93%", borderWidth: 0.01, borderColor: '#4C4C4C' }}>
                        </View>
                    </View>
                    ...
                    {!isFocusedLike && (
                        <View style={{ flexDirection: "row", height: 30, marginTop: 15 }}>
                            <TouchableOpacity onPress={() => setisFocusedLike(true)}>
                                <View style={{ marginLeft: 13, alignItems: 'center', justifyContent: 'space-evenly', flexDirection: 'row', height: 29, width: 40, borderRadius: 50, backgroundColor: "#212121" }}>
                                    <Image
                            ...
                            <TouchableOpacity onPress={toggleBottomSheet}>
                                <View style={{ marginLeft: 7, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', height: 29, width: 40, borderRadius: 50, backgroundColor: "#212121" }}>
                                    <Image
                    ...
                    {isFocusedLike && (
                        <View style={{ flexDirection: "row", height: 30, marginTop: 15 }}>
                            <TouchableOpacity onPress={() => setisFocusedLike(false)}>
                                <View style={{ marginLeft: 13, alignItems: 'center', justifyContent: 'space-evenly', flexDirection: 'row', height: 29, width: 40, borderRadius: 50, backgroundColor: "#520100" }}>
                                    <Image
                                        source={require("../../../assets/img/tym.png")}
                                        resizeMode='contain'
