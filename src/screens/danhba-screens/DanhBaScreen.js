    ...
    return (
        <View style ={styles.container}>
            ...
            {/* <TouchableOpacity style = {styles.btn} 
                ...
                <TouchableOpacity style = {styles.submenu_btn} 
                    onPress = {() => {
                ...
                >
                    <View style = {[styles.lineBottom_main,{borderColor:borderBottom1}]}>
                        <Text style = {[styles.submenu_text_main,{color:colorText1}]}>
                            Bạn bè
                        </Text>
                    </View>
                ...
                >
                    <View style = {[styles.lineBottom,{borderColor:borderBottom2}]}>
                        <Text style = {[styles.submenu_text, {color:colorText2}]}>
                        Nhóm
                        </Text>
                    </View>
                ...
                >
                    <View style = {[styles.lineBottom,{borderColor:borderBottom3}]}>
                        <Text style = {[styles.submenu_text,{color:colorText3}]}>
                            OA
                        </Text>
                    </View>
        ...
        <>
            ...
            {item.items.map(contact => (
                <TouchableOpacity key={contact.key}>
                    <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-evenly", height: 70, paddingLeft:10 }}>
...
const styles = StyleSheet.create({
    ...
    text_danhba:{
        fontSize:15, fontWeight:'600', color:"#000",width:180
    },
    border_options:{
        height:35,
        width:35,
