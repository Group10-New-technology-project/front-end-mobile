        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <Image
                    ...
                    resizeMode="contain"
                    style={{ height: 36, width: 97, marginTop: 10 }}
                />
                <Image
            ...
            <View style={styles.footer}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <TouchableOpacity onPress={() => navigation.navigate('DangNhap')}>
                        <View style={{ height: 46, width: 274, backgroundColor: "#00A3FF", borderRadius: 50, alignItems: "center", justifyContent: "center" }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('NhapSoDienThoai')}>
                        <View style={{ marginTop: 13, height: 46, width: 274, backgroundColor: "#F3F4F8", borderRadius: 50, alignItems: "center", justifyContent: "center" }}>
