  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.container_taikhoan}>
        <Text style={{ fontSize: 15, fontWeight: "bold", color: "#0008C0", marginTop: 10 }}>Tài khoản</Text>
      ...
      <View style={styles.container_baomat}>
        ...
        <View style={styles.kiemtrabaomat}>
          ...
          <View style={{ flexDirection: "column", marginLeft: 16, marginTop: 5 }}>
            ...
            <Text style={{ fontSize: 16, color: "#CED071", fontWeight: "400", marginTop: 3 }}>2 vấn đề bảo mật cần xử lý</Text>
          </View>
          <View style={{ position: "absolute", right: 20 }}>
            <Image source={require("../assets/image/Vector.png")} />
          </View>
      ...
      <View style={styles.container_dangnhap}>
        ...
        <View style={styles.kiemtrabaomat}>
          ...
          <View style={{ flexDirection: "column", marginLeft: 16, marginTop: 5 }}>
            ...
            <Text style={{ fontSize: 16, fontWeight: "400", marginTop: 3 }}>Thêm hình thức xác nhận bảo vệ tài khoản</Text>
          </View>
          <View style={{ position: "absolute", right: 20 }}>
            <Image source={require("../assets/image/Vector.png")} />
          </View>
      ...
      <View style={styles.xoa_tai_khoan}>
        ...
        <View style={{ position: "absolute", right: 20 + 12 }}>
          <Image source={require("../assets/image/Vector.png")} />
        </View>
      </View>
    </ScrollView>
